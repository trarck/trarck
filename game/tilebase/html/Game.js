...
tb.isoUtil=new isometric.Coord({
    xUnit:tb.unit.x,
    yUnit:tb.unit.y,
    originPosition:{x:0,y:0}//x:1024,y:1120 //1024,1120//1028,y:1124
});
...
var run= {
    active: function() {
        ...
        $.event.add(tb.world,'mousedown', function(e,position) {
            console.log("on mousedown:",position,tb.isoUtil.positionToMapGrid(position.x,position.y));
            self.moveable=true;
    ...
    onClick: function(e,position) {
        ...
        console.log(now-this.lastClickTime)
