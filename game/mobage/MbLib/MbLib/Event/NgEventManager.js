...
/**
 * use ngcore MessageEmitter and MessageListener
 */
var NgEventManager=exports.NgEventManager=Core.MessageListener.subclass({
    
    classname:"NgEventManager",
    ...
    getEventHandle:function(type,obj,params){
       throw "EventListenerManager's getEventHandle not implement";
    }
});