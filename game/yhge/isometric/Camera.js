(function() {
    ...
    var Camera=isometric.Camera= function () {
    ...
    Camera.prototype= {
        ...
        initRange: function () {
            ...
            var range= {
                minX:0,
                minY:0,
                maxX:worldSize.width-this._size.width,
                maxY:worldSize.height-this._size.height
            };
            this.setRange(range);
        },
        ...
        getPosition: function() {
            return {
                x:-this._world._position.x,
                y:-this._world._position.y
            }
        },
