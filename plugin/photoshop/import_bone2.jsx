...
function importFromFileAndTexturePath(file,texturePath,name){
	...
	var currentDoc=app.activeDocument;//app.documents.add(canvasWidth, canvasHeight,72, "boneDoc", NewDocumentMode.RGB,DocumentFill.TRANSPARENT);
...
//	}
	...
	importFromFileAndTexturePath(new File(jsonFolderPath+"AM/cha.json"),texgtureFolderPath+"/AM/","AM");
