...
var EventListenerManager  = require('./EventListenerManager').EventListenerManager;
var EventObject  = require('./EventObject').EventObject;

var TouchHandler  = require('./TouchHandler').TouchHandler;

var NgEventListenerManager=exports.NgEventListenerManager=EventListenerManager.singleton({
    
    classname:"NgEventListenerManager",
        ...
        switch (cat) {
            case "touch":
                ...
                if(Util.isPlainObject(params)){
                    ...
                    obj.addChild(touchTarget);
                    obj._touchTarget_=touchTarget;
                }
                touchTarget && touchTarget.getTouchEmitter().addListener(this,function(touch){
                    return eventHandle(touch);
