tb.tile.Moveable=yhge.core.extend(tb.tile.BaseTile, {
    ...
    setDirection: function(direction) {
        ...
        this._screenDirection=yhge.isometric.toScreenDirection(this._direction);
        if(this._view){
            this._directionIndex=yhge.isometric.DirectionIndex[direction.y][direction.x];
            var backPositionX=0,
    ...
    _prepareToMove: function(x,y,z,hasDirection) {
        ...
        if(!hasDirection){
            this.setDirection(yhge.isometric.calcDirection({
                x:this.mx,
                y:this.my
            },this._end));
        }
